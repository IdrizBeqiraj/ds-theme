...
wp_enqueue_style("bootstrapt.min",get_template_directory_uri()."/css/bootstrap.min.css", false,"1.0","all");
wp_enqueue_script("main",get_template_directory_uri()."/js/main.js",array('jquery'),"1.0", true);
wp_enqueue_script("bootstrapt.bundle.min",get_template_directory_uri()."/js/bootstarpt.bundle.min.js",array('jquery'),"1.0", true);
